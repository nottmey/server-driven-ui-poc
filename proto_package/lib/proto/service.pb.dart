...
class Experience extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Experience', createEmptyInstance: create)
    ..aOM<$3.WidgetExpression>(2, _omitFieldNames ? '' : 'widget', subBuilder: $3.WidgetExpression.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3.WidgetExpression get widget => $_getN(0);
  @$pb.TagNumber(2)
  set widget($3.WidgetExpression v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasWidget() => $_has(0);
  @$pb.TagNumber(2)
  void clearWidget() => clearField(2);
  @$pb.TagNumber(2)
  $3.WidgetExpression ensureWidget() => $_ensure(0);
}
