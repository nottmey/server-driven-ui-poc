  ...
  switch (tree.whichResult()) {
    ...
    case proto.WidgetExpression_Result.cupertinoApp:
      return $c2.CupertinoApp(
          ...
          color: (tree.cupertinoApp.hasColor() ? types.evaluateDartColorExpression(tree.cupertinoApp.color) : null),
          locale: null,
    ...
    case proto.WidgetExpression_Result.cupertinoAppNamedRouter:
      return $c3.CupertinoApp.router(
          ...
          onGenerateTitle: null,
          color: (tree.cupertinoAppNamedRouter.hasColor() ? types.evaluateDartColorExpression(tree.cupertinoAppNamedRouter.color) : null),
          locale: null,
          localizationsDelegates: null,
          localeListResolutionCallback: null,
          localeResolutionCallback: null,
    ...
    case proto.WidgetExpression_Result.cupertinoCheckbox:
      return $c6.CupertinoCheckbox(
          ...
          onChanged: null,
          activeColor: (tree.cupertinoCheckbox.hasActiveColor() ? types.evaluateDartColorExpression(tree.cupertinoCheckbox.activeColor) : null),
          inactiveColor: (tree.cupertinoCheckbox.hasInactiveColor() ? types.evaluateDartColorExpression(tree.cupertinoCheckbox.inactiveColor) : null),
          checkColor: (tree.cupertinoCheckbox.hasCheckColor() ? types.evaluateDartColorExpression(tree.cupertinoCheckbox.checkColor) : null),
          focusColor: (tree.cupertinoCheckbox.hasFocusColor() ? types.evaluateDartColorExpression(tree.cupertinoCheckbox.focusColor) : null),
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.cupertinoNavigationBar:
      return $c25.CupertinoNavigationBar(
          ...
          border: null,
          backgroundColor: (tree.cupertinoNavigationBar.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.cupertinoNavigationBar.backgroundColor) : null),
    ...
    case proto.WidgetExpression_Result.cupertinoSliverNavigationBar:
      return $c27.CupertinoSliverNavigationBar(
          ...
          border: null,
          backgroundColor: (tree.cupertinoSliverNavigationBar.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.cupertinoSliverNavigationBar.backgroundColor) : null),
    ...
    case proto.WidgetExpression_Result.cupertinoSwitch:
      return $c35.CupertinoSwitch(
          ...
          onChanged: null,
          activeColor: (tree.cupertinoSwitch.hasActiveColor() ? types.evaluateDartColorExpression(tree.cupertinoSwitch.activeColor) : null),
          trackColor: (tree.cupertinoSwitch.hasTrackColor() ? types.evaluateDartColorExpression(tree.cupertinoSwitch.trackColor) : null),
          thumbColor: (tree.cupertinoSwitch.hasThumbColor() ? types.evaluateDartColorExpression(tree.cupertinoSwitch.thumbColor) : null),
          applyTheme: (tree.cupertinoSwitch.hasApplyTheme() ? tree.cupertinoSwitch.applyTheme : null),
          focusColor: (tree.cupertinoSwitch.hasFocusColor() ? types.evaluateDartColorExpression(tree.cupertinoSwitch.focusColor) : null),
          focusNode: null,
          onFocusChange: null,
          autofocus: (tree.cupertinoSwitch.hasAutofocus() ? tree.cupertinoSwitch.autofocus : false),
          dragStartBehavior: (tree.cupertinoSwitch.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.cupertinoSwitch.dragStartBehavior) : missing('dragStartBehavior')));
    ...
    case proto.WidgetExpression_Result.cupertinoTextField:
      return $c37.CupertinoTextField(
          ...
          prefixMode: (tree.cupertinoTextField.hasPrefixMode() ? enums.convertRequiredOverlayVisibilityMode(tree.cupertinoTextField.prefixMode) : missing('prefixMode')),
          suffix: (tree.cupertinoTextField.hasSuffix() ? evaluateWidgetExpression(tree.cupertinoTextField.suffix) : null),
          suffixMode: (tree.cupertinoTextField.hasSuffixMode() ? enums.convertRequiredOverlayVisibilityMode(tree.cupertinoTextField.suffixMode) : missing('suffixMode')),
          clearButtonMode: (tree.cupertinoTextField.hasClearButtonMode() ? enums.convertRequiredOverlayVisibilityMode(tree.cupertinoTextField.clearButtonMode) : missing('clearButtonMode')),
          keyboardType: null,
          ...
          textCapitalization: (tree.cupertinoTextField.hasTextCapitalization() ? enums.convertRequiredFlutterTextCapitalization(tree.cupertinoTextField.textCapitalization) : missing('textCapitalization')),
          style: null,
          strutStyle: null,
          textAlign: (tree.cupertinoTextField.hasTextAlign() ? enums.convertRequiredDartTextAlign(tree.cupertinoTextField.textAlign) : missing('textAlign')),
          ...
          cursorColor: (tree.cupertinoTextField.hasCursorColor() ? types.evaluateDartColorExpression(tree.cupertinoTextField.cursorColor) : null),
          ...
          dragStartBehavior: (tree.cupertinoTextField.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.cupertinoTextField.dragStartBehavior) : missing('dragStartBehavior')),
          ...
          clipBehavior: (tree.cupertinoTextField.hasClipBehavior() ? enums.convertRequiredDartClip(tree.cupertinoTextField.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.cupertinoTextFieldNamedBorderless:
      return $c38.CupertinoTextField.borderless(
          ...
          prefixMode: (tree.cupertinoTextFieldNamedBorderless.hasPrefixMode() ? enums.convertRequiredOverlayVisibilityMode(tree.cupertinoTextFieldNamedBorderless.prefixMode) : missing('prefixMode')),
          ...
          suffixMode: (tree.cupertinoTextFieldNamedBorderless.hasSuffixMode() ? enums.convertRequiredOverlayVisibilityMode(tree.cupertinoTextFieldNamedBorderless.suffixMode) : missing('suffixMode')),
          clearButtonMode: (tree.cupertinoTextFieldNamedBorderless.hasClearButtonMode() ? enums.convertRequiredOverlayVisibilityMode(tree.cupertinoTextFieldNamedBorderless.clearButtonMode) : missing('clearButtonMode')),
          keyboardType: null,
          ...
          textCapitalization: (tree.cupertinoTextFieldNamedBorderless.hasTextCapitalization() ? enums.convertRequiredFlutterTextCapitalization(tree.cupertinoTextFieldNamedBorderless.textCapitalization) : missing('textCapitalization')),
          style: null,
          strutStyle: null,
          textAlign: (tree.cupertinoTextFieldNamedBorderless.hasTextAlign() ? enums.convertRequiredDartTextAlign(tree.cupertinoTextFieldNamedBorderless.textAlign) : missing('textAlign')),
          textAlignVertical: null,
          ...
          cursorColor: (tree.cupertinoTextFieldNamedBorderless.hasCursorColor() ? types.evaluateDartColorExpression(tree.cupertinoTextFieldNamedBorderless.cursorColor) : null),
          ...
          dragStartBehavior: (tree.cupertinoTextFieldNamedBorderless.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.cupertinoTextFieldNamedBorderless.dragStartBehavior) : missing('dragStartBehavior')),
          ...
          contentInsertionConfiguration: null,
          clipBehavior: (tree.cupertinoTextFieldNamedBorderless.hasClipBehavior() ? enums.convertRequiredDartClip(tree.cupertinoTextFieldNamedBorderless.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.cupertinoTextFormFieldRow:
      return $c39.CupertinoTextFormFieldRow(
          ...
          decoration: null,
          keyboardType: null,
          textCapitalization: (tree.cupertinoTextFormFieldRow.hasTextCapitalization() ? enums.convertRequiredFlutterTextCapitalization(tree.cupertinoTextFormFieldRow.textCapitalization) : missing('textCapitalization')),
          ...
          textAlign: (tree.cupertinoTextFormFieldRow.hasTextAlign() ? enums.convertRequiredDartTextAlign(tree.cupertinoTextFormFieldRow.textAlign) : missing('textAlign')),
          textAlignVertical: null,
          ...
          cursorColor: (tree.cupertinoTextFormFieldRow.hasCursorColor() ? types.evaluateDartColorExpression(tree.cupertinoTextFormFieldRow.cursorColor) : null),
    ...
    case proto.WidgetExpression_Result.materialActionChip:
      return $c53.ActionChip(
          ...
          side: null,
          shape: null,
          clipBehavior: (tree.materialActionChip.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialActionChip.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialActionChip.hasAutofocus() ? tree.materialActionChip.autofocus : false),
          color: null,
          backgroundColor: (tree.materialActionChip.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialActionChip.backgroundColor) : null),
          disabledColor: (tree.materialActionChip.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialActionChip.disabledColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialActionChip.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialActionChip.shadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialActionChipNamedElevated:
      return $c54.ActionChip.elevated(
          ...
          side: null,
          shape: null,
          clipBehavior: (tree.materialActionChipNamedElevated.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialActionChipNamedElevated.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialActionChipNamedElevated.hasAutofocus() ? tree.materialActionChipNamedElevated.autofocus : false),
          color: null,
          backgroundColor: (tree.materialActionChipNamedElevated.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialActionChipNamedElevated.backgroundColor) : null),
          disabledColor: (tree.materialActionChipNamedElevated.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialActionChipNamedElevated.disabledColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialActionChipNamedElevated.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialActionChipNamedElevated.shadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialMaterialApp:
      return $c55.MaterialApp(
          ...
          onGenerateTitle: null,
          color: (tree.materialMaterialApp.hasColor() ? types.evaluateDartColorExpression(tree.materialMaterialApp.color) : null),
          theme: null,
          darkTheme: null,
          highContrastTheme: null,
          highContrastDarkTheme: null,
          themeMode: (tree.materialMaterialApp.hasThemeMode() ? enums.convertMaterialThemeMode(tree.materialMaterialApp.themeMode) : null),
    ...
    case proto.WidgetExpression_Result.materialMaterialAppNamedRouter:
      return $c56.MaterialApp.router(
          ...
          onGenerateTitle: null,
          color: (tree.materialMaterialAppNamedRouter.hasColor() ? types.evaluateDartColorExpression(tree.materialMaterialAppNamedRouter.color) : null),
          theme: null,
          darkTheme: null,
          highContrastTheme: null,
          highContrastDarkTheme: null,
          themeMode: (tree.materialMaterialAppNamedRouter.hasThemeMode() ? enums.convertMaterialThemeMode(tree.materialMaterialAppNamedRouter.themeMode) : null),
    ...
    case proto.WidgetExpression_Result.materialAppBar:
      return $c57.AppBar(
          ...
          shadowColor: (tree.materialAppBar.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialAppBar.shadowColor) : null),
          surfaceTintColor: (tree.materialAppBar.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialAppBar.surfaceTintColor) : null),
          shape: null,
          backgroundColor: (tree.materialAppBar.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialAppBar.backgroundColor) : null),
          foregroundColor: (tree.materialAppBar.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialAppBar.foregroundColor) : null),
          iconTheme: null,
    ...
    case proto.WidgetExpression_Result.materialSliverAppBar:
      return $c58.SliverAppBar(
          ...
          shadowColor: (tree.materialSliverAppBar.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBar.shadowColor) : null),
          surfaceTintColor: (tree.materialSliverAppBar.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBar.surfaceTintColor) : null),
          forceElevated: (tree.materialSliverAppBar.hasForceElevated() ? tree.materialSliverAppBar.forceElevated : false),
          backgroundColor: (tree.materialSliverAppBar.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBar.backgroundColor) : null),
          foregroundColor: (tree.materialSliverAppBar.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBar.foregroundColor) : null),
          iconTheme: null,
          actionsIconTheme: null,
    ...
    case proto.WidgetExpression_Result.materialSliverAppBarNamedMedium:
      return $c59.SliverAppBar.medium(
          ...
          shadowColor: (tree.materialSliverAppBarNamedMedium.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedMedium.shadowColor) : null),
          surfaceTintColor: (tree.materialSliverAppBarNamedMedium.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedMedium.surfaceTintColor) : null),
          ...
          backgroundColor: (tree.materialSliverAppBarNamedMedium.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedMedium.backgroundColor) : null),
          foregroundColor: (tree.materialSliverAppBarNamedMedium.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedMedium.foregroundColor) : null),
          iconTheme: null,
          actionsIconTheme: null,
    ...
    case proto.WidgetExpression_Result.materialSliverAppBarNamedLarge:
      return $c60.SliverAppBar.large(
          ...
          shadowColor: (tree.materialSliverAppBarNamedLarge.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedLarge.shadowColor) : null),
          surfaceTintColor: (tree.materialSliverAppBarNamedLarge.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedLarge.surfaceTintColor) : null),
          ...
          backgroundColor: (tree.materialSliverAppBarNamedLarge.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedLarge.backgroundColor) : null),
          foregroundColor: (tree.materialSliverAppBarNamedLarge.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialSliverAppBarNamedLarge.foregroundColor) : null),
          iconTheme: null,
          actionsIconTheme: null,
    ...
    case proto.WidgetExpression_Result.materialMaterialBanner:
      return $c63.MaterialBanner(
          ...
          backgroundColor: (tree.materialMaterialBanner.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialMaterialBanner.backgroundColor) : null),
          surfaceTintColor: (tree.materialMaterialBanner.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialMaterialBanner.surfaceTintColor) : null),
          shadowColor: (tree.materialMaterialBanner.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialMaterialBanner.shadowColor) : null),
          dividerColor: (tree.materialMaterialBanner.hasDividerColor() ? types.evaluateDartColorExpression(tree.materialMaterialBanner.dividerColor) : null),
          padding: null,
          margin: null,
          leadingPadding: null,
          forceActionsBelow: (tree.materialMaterialBanner.hasForceActionsBelow() ? tree.materialMaterialBanner.forceActionsBelow : false),
          overflowAlignment: (tree.materialMaterialBanner.hasOverflowAlignment() ? enums.convertRequiredFlutterOverflowBarAlignment(tree.materialMaterialBanner.overflowAlignment) : missing('overflowAlignment')),
          animation: null,
          onVisible: null);
    ...
    case proto.WidgetExpression_Result.materialBottomAppBar:
      return $c65.BottomAppBar(
          ...
          shape: null,
          clipBehavior: (tree.materialBottomAppBar.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialBottomAppBar.clipBehavior) : missing('clipBehavior')),
          ...
          padding: null,
          surfaceTintColor: (tree.materialBottomAppBar.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialBottomAppBar.surfaceTintColor) : null),
    ...
    case proto.WidgetExpression_Result.materialRawMaterialButton:
      return $c66.RawMaterialButton(
          ...
          highlightColor: (tree.materialRawMaterialButton.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialRawMaterialButton.highlightColor) : null),
          splashColor: (tree.materialRawMaterialButton.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialRawMaterialButton.splashColor) : null),
          ...
          clipBehavior: (tree.materialRawMaterialButton.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialRawMaterialButton.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialButtonTheme:
      return $c68.ButtonTheme(
          ...
          textTheme: (tree.materialButtonTheme.hasTextTheme() ? enums.convertRequiredMaterialButtonTextTheme(tree.materialButtonTheme.textTheme) : missing('textTheme')),
          layoutBehavior: (tree.materialButtonTheme.hasLayoutBehavior() ? enums.convertRequiredMaterialButtonBarLayoutBehavior(tree.materialButtonTheme.layoutBehavior) : missing('layoutBehavior')),
          ...
          buttonColor: (tree.materialButtonTheme.hasButtonColor() ? types.evaluateDartColorExpression(tree.materialButtonTheme.buttonColor) : null),
          disabledColor: (tree.materialButtonTheme.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialButtonTheme.disabledColor) : null),
          focusColor: (tree.materialButtonTheme.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialButtonTheme.focusColor) : null),
          hoverColor: (tree.materialButtonTheme.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialButtonTheme.hoverColor) : null),
          highlightColor: (tree.materialButtonTheme.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialButtonTheme.highlightColor) : null),
          splashColor: (tree.materialButtonTheme.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialButtonTheme.splashColor) : null),
          colorScheme: null,
    ...
    case proto.WidgetExpression_Result.materialCard:
      return $c69.Card(
          ...
          surfaceTintColor: (tree.materialCard.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialCard.surfaceTintColor) : null),
    ...
    case proto.WidgetExpression_Result.materialCheckbox:
      return $c70.Checkbox(
          ...
          onChanged: null,
          mouseCursor: null,
          activeColor: (tree.materialCheckbox.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialCheckbox.activeColor) : null),
          fillColor: null,
          checkColor: (tree.materialCheckbox.hasCheckColor() ? types.evaluateDartColorExpression(tree.materialCheckbox.checkColor) : null),
          focusColor: (tree.materialCheckbox.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialCheckbox.focusColor) : null),
          hoverColor: (tree.materialCheckbox.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialCheckbox.hoverColor) : null),
          overlayColor: null,
    ...
    case proto.WidgetExpression_Result.materialCheckboxNamedAdaptive:
      return $c71.Checkbox.adaptive(
          ...
          onChanged: null,
          mouseCursor: null,
          activeColor: (tree.materialCheckboxNamedAdaptive.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialCheckboxNamedAdaptive.activeColor) : null),
          fillColor: null,
          checkColor: (tree.materialCheckboxNamedAdaptive.hasCheckColor() ? types.evaluateDartColorExpression(tree.materialCheckboxNamedAdaptive.checkColor) : null),
          focusColor: (tree.materialCheckboxNamedAdaptive.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialCheckboxNamedAdaptive.focusColor) : null),
          hoverColor: (tree.materialCheckboxNamedAdaptive.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialCheckboxNamedAdaptive.hoverColor) : null),
          overlayColor: null,
    ...
    case proto.WidgetExpression_Result.materialCheckboxListTile:
      return $c72.CheckboxListTile(
          ...
          onChanged: null,
          mouseCursor: null,
          activeColor: (tree.materialCheckboxListTile.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTile.activeColor) : null),
          fillColor: null,
          checkColor: (tree.materialCheckboxListTile.hasCheckColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTile.checkColor) : null),
          hoverColor: (tree.materialCheckboxListTile.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTile.hoverColor) : null),
          overlayColor: null,
          ...
          tileColor: (tree.materialCheckboxListTile.hasTileColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTile.tileColor) : null),
          ...
          controlAffinity: (tree.materialCheckboxListTile.hasControlAffinity() ? enums.convertRequiredMaterialListTileControlAffinity(tree.materialCheckboxListTile.controlAffinity) : missing('controlAffinity')),
          contentPadding: null,
          tristate: (tree.materialCheckboxListTile.hasTristate() ? tree.materialCheckboxListTile.tristate : false),
          checkboxShape: null,
          selectedTileColor: (tree.materialCheckboxListTile.hasSelectedTileColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTile.selectedTileColor) : null),
          onFocusChange: null,
    ...
    case proto.WidgetExpression_Result.materialCheckboxListTileNamedAdaptive:
      return $c73.CheckboxListTile.adaptive(
          ...
          onChanged: null,
          mouseCursor: null,
          activeColor: (tree.materialCheckboxListTileNamedAdaptive.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTileNamedAdaptive.activeColor) : null),
          fillColor: null,
          checkColor: (tree.materialCheckboxListTileNamedAdaptive.hasCheckColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTileNamedAdaptive.checkColor) : null),
          hoverColor: (tree.materialCheckboxListTileNamedAdaptive.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTileNamedAdaptive.hoverColor) : null),
          overlayColor: null,
          ...
          tileColor: (tree.materialCheckboxListTileNamedAdaptive.hasTileColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTileNamedAdaptive.tileColor) : null),
          ...
          controlAffinity: (tree.materialCheckboxListTileNamedAdaptive.hasControlAffinity() ? enums.convertRequiredMaterialListTileControlAffinity(tree.materialCheckboxListTileNamedAdaptive.controlAffinity) : missing('controlAffinity')),
          contentPadding: null,
          ...
          checkboxShape: null,
          selectedTileColor: (tree.materialCheckboxListTileNamedAdaptive.hasSelectedTileColor() ? types.evaluateDartColorExpression(tree.materialCheckboxListTileNamedAdaptive.selectedTileColor) : null),
          onFocusChange: null,
    ...
    case proto.WidgetExpression_Result.materialChip:
      return $c74.Chip(
          ...
          onDeleted: null,
          deleteIconColor: (tree.materialChip.hasDeleteIconColor() ? types.evaluateDartColorExpression(tree.materialChip.deleteIconColor) : null),
          ...
          side: null,
          shape: null,
          clipBehavior: (tree.materialChip.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialChip.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialChip.hasAutofocus() ? tree.materialChip.autofocus : false),
          color: null,
          backgroundColor: (tree.materialChip.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialChip.backgroundColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialChip.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialChip.shadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialRawChip:
      return $c75.RawChip(
          ...
          onDeleted: null,
          deleteIconColor: (tree.materialRawChip.hasDeleteIconColor() ? types.evaluateDartColorExpression(tree.materialRawChip.deleteIconColor) : null),
          ...
          disabledColor: (tree.materialRawChip.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialRawChip.disabledColor) : null),
          selectedColor: (tree.materialRawChip.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialRawChip.selectedColor) : null),
          tooltip: (tree.materialRawChip.hasTooltip() ? tree.materialRawChip.tooltip : null),
          side: null,
          shape: null,
          clipBehavior: (tree.materialRawChip.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialRawChip.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialRawChip.hasAutofocus() ? tree.materialRawChip.autofocus : false),
          color: null,
          backgroundColor: (tree.materialRawChip.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialRawChip.backgroundColor) : null),
          ...
          shadowColor: (tree.materialRawChip.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialRawChip.shadowColor) : null),
          surfaceTintColor: (tree.materialRawChip.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialRawChip.surfaceTintColor) : null),
          iconTheme: null,
          selectedShadowColor: (tree.materialRawChip.hasSelectedShadowColor() ? types.evaluateDartColorExpression(tree.materialRawChip.selectedShadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialChoiceChip:
      return $c76.ChoiceChip(
          ...
          selectedColor: (tree.materialChoiceChip.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialChoiceChip.selectedColor) : null),
          disabledColor: (tree.materialChoiceChip.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialChoiceChip.disabledColor) : null),
          tooltip: (tree.materialChoiceChip.hasTooltip() ? tree.materialChoiceChip.tooltip : null),
          side: null,
          shape: null,
          clipBehavior: (tree.materialChoiceChip.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialChoiceChip.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialChoiceChip.hasAutofocus() ? tree.materialChoiceChip.autofocus : false),
          color: null,
          backgroundColor: (tree.materialChoiceChip.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialChoiceChip.backgroundColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialChoiceChip.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialChoiceChip.shadowColor) : null),
          surfaceTintColor: (tree.materialChoiceChip.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialChoiceChip.surfaceTintColor) : null),
          iconTheme: null,
          selectedShadowColor: (tree.materialChoiceChip.hasSelectedShadowColor() ? types.evaluateDartColorExpression(tree.materialChoiceChip.selectedShadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialChoiceChipNamedElevated:
      return $c77.ChoiceChip.elevated(
          ...
          selectedColor: (tree.materialChoiceChipNamedElevated.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialChoiceChipNamedElevated.selectedColor) : null),
          disabledColor: (tree.materialChoiceChipNamedElevated.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialChoiceChipNamedElevated.disabledColor) : null),
          tooltip: (tree.materialChoiceChipNamedElevated.hasTooltip() ? tree.materialChoiceChipNamedElevated.tooltip : null),
          side: null,
          shape: null,
          clipBehavior: (tree.materialChoiceChipNamedElevated.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialChoiceChipNamedElevated.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialChoiceChipNamedElevated.hasAutofocus() ? tree.materialChoiceChipNamedElevated.autofocus : false),
          color: null,
          backgroundColor: (tree.materialChoiceChipNamedElevated.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialChoiceChipNamedElevated.backgroundColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialChoiceChipNamedElevated.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialChoiceChipNamedElevated.shadowColor) : null),
          surfaceTintColor: (tree.materialChoiceChipNamedElevated.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialChoiceChipNamedElevated.surfaceTintColor) : null),
          iconTheme: null,
          selectedShadowColor: (tree.materialChoiceChipNamedElevated.hasSelectedShadowColor() ? types.evaluateDartColorExpression(tree.materialChoiceChipNamedElevated.selectedShadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialCircleAvatar:
      return $c78.CircleAvatar(
          ...
          foregroundColor: (tree.materialCircleAvatar.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialCircleAvatar.foregroundColor) : null),
    ...
    case proto.WidgetExpression_Result.materialAlertDialog:
      return $c81.AlertDialog(
          ...
          buttonPadding: null,
          backgroundColor: (tree.materialAlertDialog.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialAlertDialog.backgroundColor) : null),
          elevation: (tree.materialAlertDialog.hasElevation() ? tree.materialAlertDialog.elevation : null),
          shadowColor: (tree.materialAlertDialog.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialAlertDialog.shadowColor) : null),
          surfaceTintColor: (tree.materialAlertDialog.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialAlertDialog.surfaceTintColor) : null),
          semanticLabel: (tree.materialAlertDialog.hasSemanticLabel() ? tree.materialAlertDialog.semanticLabel : null),
          clipBehavior: (tree.materialAlertDialog.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialAlertDialog.clipBehavior) : missing('clipBehavior')),
          shape: null,
          alignment: null,
    ...
    case proto.WidgetExpression_Result.materialAlertDialogNamedAdaptive:
      return $c82.AlertDialog.adaptive(
          ...
          buttonPadding: null,
          backgroundColor: (tree.materialAlertDialogNamedAdaptive.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialAlertDialogNamedAdaptive.backgroundColor) : null),
          elevation: (tree.materialAlertDialogNamedAdaptive.hasElevation() ? tree.materialAlertDialogNamedAdaptive.elevation : null),
          shadowColor: (tree.materialAlertDialogNamedAdaptive.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialAlertDialogNamedAdaptive.shadowColor) : null),
          surfaceTintColor: (tree.materialAlertDialogNamedAdaptive.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialAlertDialogNamedAdaptive.surfaceTintColor) : null),
    ...
    case proto.WidgetExpression_Result.materialDialog:
      return $c83.Dialog(
          ...
          shadowColor: (tree.materialDialog.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialDialog.shadowColor) : null),
          surfaceTintColor: (tree.materialDialog.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialDialog.surfaceTintColor) : null),
          insetAnimationDuration: (tree.materialDialog.hasInsetAnimationDuration() ? types.evaluateRequiredDartDurationExpression(tree.materialDialog.insetAnimationDuration) : missing('insetAnimationDuration')),
          insetPadding: null,
          clipBehavior: (tree.materialDialog.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialDialog.clipBehavior) : missing('clipBehavior')),
          shape: null,
          alignment: null,
    ...
    case proto.WidgetExpression_Result.materialSimpleDialog:
      return $c85.SimpleDialog(
          ...
          shadowColor: (tree.materialSimpleDialog.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialSimpleDialog.shadowColor) : null),
          surfaceTintColor: (tree.materialSimpleDialog.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialSimpleDialog.surfaceTintColor) : null),
          semanticLabel: (tree.materialSimpleDialog.hasSemanticLabel() ? tree.materialSimpleDialog.semanticLabel : null),
          clipBehavior: (tree.materialSimpleDialog.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialSimpleDialog.clipBehavior) : missing('clipBehavior')),
          shape: null,
          alignment: null);
    ...
    case proto.WidgetExpression_Result.materialDrawer:
      return $c89.Drawer(
          ...
          shadowColor: (tree.materialDrawer.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialDrawer.shadowColor) : null),
          surfaceTintColor: (tree.materialDrawer.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialDrawer.surfaceTintColor) : null),
          shape: null,
    ...
    case proto.WidgetExpression_Result.materialDrawerController:
      return $c90.DrawerController(
          ...
          drawerCallback: null,
          dragStartBehavior: (tree.materialDrawerController.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialDrawerController.dragStartBehavior) : missing('dragStartBehavior')),
          scrimColor: (tree.materialDrawerController.hasScrimColor() ? types.evaluateDartColorExpression(tree.materialDrawerController.scrimColor) : null),
    ...
    case proto.WidgetExpression_Result.materialDropdownButton:
      return $c92.DropdownButton(
          ...
          iconEnabledColor: (tree.materialDropdownButton.hasIconEnabledColor() ? types.evaluateDartColorExpression(tree.materialDropdownButton.iconEnabledColor) : null),
          ...
          dropdownColor: (tree.materialDropdownButton.hasDropdownColor() ? types.evaluateDartColorExpression(tree.materialDropdownButton.dropdownColor) : null),
    ...
    case proto.WidgetExpression_Result.materialDropdownButtonFormField:
      return $c93.DropdownButtonFormField(
          ...
          focusColor: (tree.materialDropdownButtonFormField.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialDropdownButtonFormField.focusColor) : null),
          focusNode: null,
          autofocus: (tree.materialDropdownButtonFormField.hasAutofocus() ? tree.materialDropdownButtonFormField.autofocus : false),
          dropdownColor: (tree.materialDropdownButtonFormField.hasDropdownColor() ? types.evaluateDartColorExpression(tree.materialDropdownButtonFormField.dropdownColor) : null),
          decoration: null,
          onSaved: null,
          validator: null,
    ...
    case proto.WidgetExpression_Result.materialExpandIcon:
      return $c98.ExpandIcon(
          ...
          onPressed: null,
          color: (tree.materialExpandIcon.hasColor() ? types.evaluateDartColorExpression(tree.materialExpandIcon.color) : null),
    ...
    case proto.WidgetExpression_Result.materialExpansionTile:
      return $c101.ExpansionTile(
          ...
          backgroundColor: (tree.materialExpansionTile.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialExpansionTile.backgroundColor) : null),
          collapsedBackgroundColor: (tree.materialExpansionTile.hasCollapsedBackgroundColor() ? types.evaluateDartColorExpression(tree.materialExpansionTile.collapsedBackgroundColor) : null),
          textColor: (tree.materialExpansionTile.hasTextColor() ? types.evaluateDartColorExpression(tree.materialExpansionTile.textColor) : null),
          collapsedTextColor: (tree.materialExpansionTile.hasCollapsedTextColor() ? types.evaluateDartColorExpression(tree.materialExpansionTile.collapsedTextColor) : null),
          iconColor: (tree.materialExpansionTile.hasIconColor() ? types.evaluateDartColorExpression(tree.materialExpansionTile.iconColor) : null),
          collapsedIconColor: (tree.materialExpansionTile.hasCollapsedIconColor() ? types.evaluateDartColorExpression(tree.materialExpansionTile.collapsedIconColor) : null),
          shape: null,
          collapsedShape: null,
    ...
    case proto.WidgetExpression_Result.materialFilterChip:
      return $c106.FilterChip(
          ...
          disabledColor: (tree.materialFilterChip.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialFilterChip.disabledColor) : null),
          selectedColor: (tree.materialFilterChip.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialFilterChip.selectedColor) : null),
          tooltip: (tree.materialFilterChip.hasTooltip() ? tree.materialFilterChip.tooltip : null),
          side: null,
          shape: null,
          clipBehavior: (tree.materialFilterChip.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialFilterChip.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialFilterChip.hasAutofocus() ? tree.materialFilterChip.autofocus : false),
          color: null,
          backgroundColor: (tree.materialFilterChip.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialFilterChip.backgroundColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialFilterChip.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialFilterChip.shadowColor) : null),
          surfaceTintColor: (tree.materialFilterChip.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialFilterChip.surfaceTintColor) : null),
          iconTheme: null,
          selectedShadowColor: (tree.materialFilterChip.hasSelectedShadowColor() ? types.evaluateDartColorExpression(tree.materialFilterChip.selectedShadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialFilterChipNamedElevated:
      return $c107.FilterChip.elevated(
          ...
          disabledColor: (tree.materialFilterChipNamedElevated.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialFilterChipNamedElevated.disabledColor) : null),
          selectedColor: (tree.materialFilterChipNamedElevated.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialFilterChipNamedElevated.selectedColor) : null),
          tooltip: (tree.materialFilterChipNamedElevated.hasTooltip() ? tree.materialFilterChipNamedElevated.tooltip : null),
          side: null,
          shape: null,
          clipBehavior: (tree.materialFilterChipNamedElevated.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialFilterChipNamedElevated.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialFilterChipNamedElevated.hasAutofocus() ? tree.materialFilterChipNamedElevated.autofocus : false),
          color: null,
          backgroundColor: (tree.materialFilterChipNamedElevated.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialFilterChipNamedElevated.backgroundColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialFilterChipNamedElevated.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialFilterChipNamedElevated.shadowColor) : null),
          surfaceTintColor: (tree.materialFilterChipNamedElevated.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialFilterChipNamedElevated.surfaceTintColor) : null),
          iconTheme: null,
          selectedShadowColor: (tree.materialFilterChipNamedElevated.hasSelectedShadowColor() ? types.evaluateDartColorExpression(tree.materialFilterChipNamedElevated.selectedShadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialFlexibleSpaceBar:
      return $c108.FlexibleSpaceBar(
          ...
          titlePadding: null,
          collapseMode: (tree.materialFlexibleSpaceBar.hasCollapseMode() ? enums.convertRequiredMaterialCollapseMode(tree.materialFlexibleSpaceBar.collapseMode) : missing('collapseMode')),
    ...
    case proto.WidgetExpression_Result.materialFloatingActionButton:
      return $c110.FloatingActionButton(
          ...
          foregroundColor: (tree.materialFloatingActionButton.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButton.foregroundColor) : null),
          backgroundColor: (tree.materialFloatingActionButton.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButton.backgroundColor) : null),
          focusColor: (tree.materialFloatingActionButton.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButton.focusColor) : null),
          hoverColor: (tree.materialFloatingActionButton.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButton.hoverColor) : null),
          splashColor: (tree.materialFloatingActionButton.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButton.splashColor) : null),
          heroTag: null,
          ...
          shape: null,
          clipBehavior: (tree.materialFloatingActionButton.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialFloatingActionButton.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialFloatingActionButtonNamedSmall:
      return $c111.FloatingActionButton.small(
          ...
          foregroundColor: (tree.materialFloatingActionButtonNamedSmall.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedSmall.foregroundColor) : null),
          backgroundColor: (tree.materialFloatingActionButtonNamedSmall.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedSmall.backgroundColor) : null),
          focusColor: (tree.materialFloatingActionButtonNamedSmall.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedSmall.focusColor) : null),
          hoverColor: (tree.materialFloatingActionButtonNamedSmall.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedSmall.hoverColor) : null),
          splashColor: (tree.materialFloatingActionButtonNamedSmall.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedSmall.splashColor) : null),
          heroTag: null,
          ...
          mouseCursor: null,
          shape: null,
          clipBehavior: (tree.materialFloatingActionButtonNamedSmall.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialFloatingActionButtonNamedSmall.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialFloatingActionButtonNamedLarge:
      return $c112.FloatingActionButton.large(
          ...
          foregroundColor: (tree.materialFloatingActionButtonNamedLarge.hasForegroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedLarge.foregroundColor) : null),
          backgroundColor: (tree.materialFloatingActionButtonNamedLarge.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedLarge.backgroundColor) : null),
          focusColor: (tree.materialFloatingActionButtonNamedLarge.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedLarge.focusColor) : null),
          hoverColor: (tree.materialFloatingActionButtonNamedLarge.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedLarge.hoverColor) : null),
          splashColor: (tree.materialFloatingActionButtonNamedLarge.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedLarge.splashColor) : null),
          heroTag: null,
          ...
          mouseCursor: null,
          shape: null,
          clipBehavior: (tree.materialFloatingActionButtonNamedLarge.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialFloatingActionButtonNamedLarge.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialFloatingActionButtonNamedExtended:
      return $c113.FloatingActionButton.extended(
          ...
          backgroundColor: (tree.materialFloatingActionButtonNamedExtended.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedExtended.backgroundColor) : null),
          focusColor: (tree.materialFloatingActionButtonNamedExtended.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedExtended.focusColor) : null),
          hoverColor: (tree.materialFloatingActionButtonNamedExtended.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedExtended.hoverColor) : null),
          heroTag: null,
          ...
          splashColor: (tree.materialFloatingActionButtonNamedExtended.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialFloatingActionButtonNamedExtended.splashColor) : null),
          ...
          clipBehavior: (tree.materialFloatingActionButtonNamedExtended.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialFloatingActionButtonNamedExtended.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialFlutterLogo:
      return $c114.FlutterLogo(
          ...
          style: (tree.materialFlutterLogo.hasStyle() ? enums.convertRequiredFlutterFlutterLogoStyle(tree.materialFlutterLogo.style) : missing('style')),
    ...
    case proto.WidgetExpression_Result.materialIconButton:
      return $c117.IconButton(
          ...
          color: (tree.materialIconButton.hasColor() ? types.evaluateDartColorExpression(tree.materialIconButton.color) : null),
          focusColor: (tree.materialIconButton.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialIconButton.focusColor) : null),
          hoverColor: (tree.materialIconButton.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialIconButton.hoverColor) : null),
          highlightColor: (tree.materialIconButton.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialIconButton.highlightColor) : null),
          splashColor: (tree.materialIconButton.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialIconButton.splashColor) : null),
          disabledColor: (tree.materialIconButton.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialIconButton.disabledColor) : null),
          onPressed: null,
          mouseCursor: null,
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialIconButtonNamedFilled:
      return $c118.IconButton.filled(
          ...
          color: (tree.materialIconButtonNamedFilled.hasColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilled.color) : null),
          focusColor: (tree.materialIconButtonNamedFilled.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilled.focusColor) : null),
          hoverColor: (tree.materialIconButtonNamedFilled.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilled.hoverColor) : null),
          highlightColor: (tree.materialIconButtonNamedFilled.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilled.highlightColor) : null),
          splashColor: (tree.materialIconButtonNamedFilled.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilled.splashColor) : null),
          disabledColor: (tree.materialIconButtonNamedFilled.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilled.disabledColor) : null),
          onPressed: null,
          mouseCursor: null,
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialIconButtonNamedFilledTonal:
      return $c119.IconButton.filledTonal(
          ...
          color: (tree.materialIconButtonNamedFilledTonal.hasColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilledTonal.color) : null),
          focusColor: (tree.materialIconButtonNamedFilledTonal.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilledTonal.focusColor) : null),
          hoverColor: (tree.materialIconButtonNamedFilledTonal.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilledTonal.hoverColor) : null),
          highlightColor: (tree.materialIconButtonNamedFilledTonal.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilledTonal.highlightColor) : null),
          splashColor: (tree.materialIconButtonNamedFilledTonal.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilledTonal.splashColor) : null),
          disabledColor: (tree.materialIconButtonNamedFilledTonal.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedFilledTonal.disabledColor) : null),
          onPressed: null,
          mouseCursor: null,
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialIconButtonNamedOutlined:
      return $c120.IconButton.outlined(
          ...
          color: (tree.materialIconButtonNamedOutlined.hasColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedOutlined.color) : null),
          focusColor: (tree.materialIconButtonNamedOutlined.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedOutlined.focusColor) : null),
          hoverColor: (tree.materialIconButtonNamedOutlined.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedOutlined.hoverColor) : null),
          highlightColor: (tree.materialIconButtonNamedOutlined.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedOutlined.highlightColor) : null),
          splashColor: (tree.materialIconButtonNamedOutlined.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedOutlined.splashColor) : null),
          disabledColor: (tree.materialIconButtonNamedOutlined.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialIconButtonNamedOutlined.disabledColor) : null),
          onPressed: null,
          mouseCursor: null,
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialInkResponse:
      return $c122.InkResponse(
          ...
          highlightShape: (tree.materialInkResponse.hasHighlightShape() ? enums.convertRequiredFlutterBoxShape(tree.materialInkResponse.highlightShape) : missing('highlightShape')),
          radius: (tree.materialInkResponse.hasRadius() ? tree.materialInkResponse.radius : null),
          borderRadius: null,
          customBorder: null,
          focusColor: (tree.materialInkResponse.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialInkResponse.focusColor) : null),
          hoverColor: (tree.materialInkResponse.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialInkResponse.hoverColor) : null),
          highlightColor: (tree.materialInkResponse.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialInkResponse.highlightColor) : null),
          overlayColor: null,
          splashColor: (tree.materialInkResponse.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialInkResponse.splashColor) : null),
          splashFactory: null,
    ...
    case proto.WidgetExpression_Result.materialInkWell:
      return $c123.InkWell(
          ...
          onHover: null,
          mouseCursor: null,
          focusColor: (tree.materialInkWell.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialInkWell.focusColor) : null),
          hoverColor: (tree.materialInkWell.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialInkWell.hoverColor) : null),
          highlightColor: (tree.materialInkWell.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialInkWell.highlightColor) : null),
          overlayColor: null,
          splashColor: (tree.materialInkWell.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialInkWell.splashColor) : null),
          splashFactory: null,
    ...
    case proto.WidgetExpression_Result.materialInputChip:
      return $c124.InputChip(
          ...
          onDeleted: null,
          deleteIconColor: (tree.materialInputChip.hasDeleteIconColor() ? types.evaluateDartColorExpression(tree.materialInputChip.deleteIconColor) : null),
          ...
          disabledColor: (tree.materialInputChip.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialInputChip.disabledColor) : null),
          selectedColor: (tree.materialInputChip.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialInputChip.selectedColor) : null),
          tooltip: (tree.materialInputChip.hasTooltip() ? tree.materialInputChip.tooltip : null),
          side: null,
          shape: null,
          clipBehavior: (tree.materialInputChip.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialInputChip.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          autofocus: (tree.materialInputChip.hasAutofocus() ? tree.materialInputChip.autofocus : false),
          color: null,
          backgroundColor: (tree.materialInputChip.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialInputChip.backgroundColor) : null),
          padding: null,
          visualDensity: null,
          ...
          shadowColor: (tree.materialInputChip.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialInputChip.shadowColor) : null),
          surfaceTintColor: (tree.materialInputChip.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialInputChip.surfaceTintColor) : null),
          iconTheme: null,
          selectedShadowColor: (tree.materialInputChip.hasSelectedShadowColor() ? types.evaluateDartColorExpression(tree.materialInputChip.selectedShadowColor) : null),
    ...
    case proto.WidgetExpression_Result.materialListTile:
      return $c125.ListTile(
          ...
          focusColor: (tree.materialListTile.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialListTile.focusColor) : null),
          hoverColor: (tree.materialListTile.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialListTile.hoverColor) : null),
          splashColor: (tree.materialListTile.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialListTile.splashColor) : null),
          focusNode: null,
          autofocus: (tree.materialListTile.hasAutofocus() ? tree.materialListTile.autofocus : false),
          tileColor: (tree.materialListTile.hasTileColor() ? types.evaluateDartColorExpression(tree.materialListTile.tileColor) : null),
          selectedTileColor: (tree.materialListTile.hasSelectedTileColor() ? types.evaluateDartColorExpression(tree.materialListTile.selectedTileColor) : null),
    ...
    case proto.WidgetExpression_Result.materialListTileTheme:
      return $c126.ListTileTheme(
          ...
          selectedColor: (tree.materialListTileTheme.hasSelectedColor() ? types.evaluateDartColorExpression(tree.materialListTileTheme.selectedColor) : null),
          iconColor: (tree.materialListTileTheme.hasIconColor() ? types.evaluateDartColorExpression(tree.materialListTileTheme.iconColor) : null),
          textColor: (tree.materialListTileTheme.hasTextColor() ? types.evaluateDartColorExpression(tree.materialListTileTheme.textColor) : null),
          contentPadding: null,
          tileColor: (tree.materialListTileTheme.hasTileColor() ? types.evaluateDartColorExpression(tree.materialListTileTheme.tileColor) : null),
          selectedTileColor: (tree.materialListTileTheme.hasSelectedTileColor() ? types.evaluateDartColorExpression(tree.materialListTileTheme.selectedTileColor) : null),
    ...
    case proto.WidgetExpression_Result.materialMaterial:
      return $c128.Material(
          ...
          type: (tree.materialMaterial.hasType() ? enums.convertRequiredMaterialMaterialType(tree.materialMaterial.type) : missing('type')),
          ...
          clipBehavior: (tree.materialMaterial.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialMaterial.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.materialMaterialButton:
      return $c129.MaterialButton(
          ...
          textColor: (tree.materialMaterialButton.hasTextColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.textColor) : null),
          disabledTextColor: (tree.materialMaterialButton.hasDisabledTextColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.disabledTextColor) : null),
          color: (tree.materialMaterialButton.hasColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.color) : null),
          disabledColor: (tree.materialMaterialButton.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.disabledColor) : null),
          focusColor: (tree.materialMaterialButton.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.focusColor) : null),
          hoverColor: (tree.materialMaterialButton.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.hoverColor) : null),
          highlightColor: (tree.materialMaterialButton.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.highlightColor) : null),
          splashColor: (tree.materialMaterialButton.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialMaterialButton.splashColor) : null),
          ...
          visualDensity: null,
          shape: null,
          clipBehavior: (tree.materialMaterialButton.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialMaterialButton.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          ...
          animationDuration: (tree.materialMaterialButton.hasAnimationDuration() ? types.evaluateDartDurationExpression(tree.materialMaterialButton.animationDuration) : null),
    ...
    case proto.WidgetExpression_Result.materialCheckboxMenuButton:
      return $c130.CheckboxMenuButton(
          ...
          style: null,
          statesController: null,
          clipBehavior: (tree.materialCheckboxMenuButton.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialCheckboxMenuButton.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.materialMenuAnchor:
      return $c133.MenuAnchor(
          ...
          clipBehavior: (tree.materialMenuAnchor.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialMenuAnchor.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.materialMenuBar:
      return $c134.MenuBar(
          ...
          style: null,
          clipBehavior: (tree.materialMenuBar.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialMenuBar.clipBehavior) : missing('clipBehavior')),
          controller: null,
    ...
    case proto.WidgetExpression_Result.materialMenuItemButton:
      return $c135.MenuItemButton(
          ...
          style: null,
          statesController: null,
          clipBehavior: (tree.materialMenuItemButton.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialMenuItemButton.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.materialSubmenuButton:
      return $c136.SubmenuButton(
          ...
          menuStyle: null,
          alignmentOffset: null,
          clipBehavior: (tree.materialSubmenuButton.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialSubmenuButton.clipBehavior) : missing('clipBehavior')),
          focusNode: null,
          statesController: null,
    ...
    case proto.WidgetExpression_Result.materialMergeableMaterial:
      return $c137.MergeableMaterial(
          ...
          mainAxis: (tree.materialMergeableMaterial.hasMainAxis() ? enums.convertRequiredFlutterAxis(tree.materialMergeableMaterial.mainAxis) : missing('mainAxis')),
    ...
    case proto.WidgetExpression_Result.materialNavigationBar:
      return $c138.NavigationBar(
          ...
          backgroundColor: (tree.materialNavigationBar.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialNavigationBar.backgroundColor) : null),
          elevation: (tree.materialNavigationBar.hasElevation() ? tree.materialNavigationBar.elevation : null),
          shadowColor: (tree.materialNavigationBar.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialNavigationBar.shadowColor) : null),
          surfaceTintColor: (tree.materialNavigationBar.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialNavigationBar.surfaceTintColor) : null),
          indicatorColor: (tree.materialNavigationBar.hasIndicatorColor() ? types.evaluateDartColorExpression(tree.materialNavigationBar.indicatorColor) : null),
          indicatorShape: null,
    ...
    case proto.WidgetExpression_Result.materialNavigationDrawer:
      return $c140.NavigationDrawer(
          ...
          shadowColor: (tree.materialNavigationDrawer.hasShadowColor() ? types.evaluateDartColorExpression(tree.materialNavigationDrawer.shadowColor) : null),
          surfaceTintColor: (tree.materialNavigationDrawer.hasSurfaceTintColor() ? types.evaluateDartColorExpression(tree.materialNavigationDrawer.surfaceTintColor) : null),
          elevation: (tree.materialNavigationDrawer.hasElevation() ? tree.materialNavigationDrawer.elevation : null),
          indicatorColor: (tree.materialNavigationDrawer.hasIndicatorColor() ? types.evaluateDartColorExpression(tree.materialNavigationDrawer.indicatorColor) : null),
          indicatorShape: null,
          onDestinationSelected: null,
    ...
    case proto.WidgetExpression_Result.materialLinearProgressIndicator:
      return $c149.LinearProgressIndicator(
          ...
          color: (tree.materialLinearProgressIndicator.hasColor() ? types.evaluateDartColorExpression(tree.materialLinearProgressIndicator.color) : null),
          valueColor: null,
    ...
    case proto.WidgetExpression_Result.materialScaffold:
      return $c151.Scaffold(
          ...
          backgroundColor: (tree.materialScaffold.hasBackgroundColor() ? types.evaluateDartColorExpression(tree.materialScaffold.backgroundColor) : null),
          ...
          drawerDragStartBehavior: (tree.materialScaffold.hasDrawerDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialScaffold.drawerDragStartBehavior) : missing('drawerDragStartBehavior')),
          ...
          drawerScrimColor: (tree.materialScaffold.hasDrawerScrimColor() ? types.evaluateDartColorExpression(tree.materialScaffold.drawerScrimColor) : null),
    ...
    case proto.WidgetExpression_Result.materialSelectableText:
      return $c155.SelectableText(
          ...
          cursorRadius: null,
          cursorColor: (tree.materialSelectableText.hasCursorColor() ? types.evaluateDartColorExpression(tree.materialSelectableText.cursorColor) : null),
          ...
          dragStartBehavior: (tree.materialSelectableText.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialSelectableText.dragStartBehavior) : missing('dragStartBehavior')),
    ...
    case proto.WidgetExpression_Result.materialSlider:
      return $c157.Slider(
          ...
          activeColor: (tree.materialSlider.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialSlider.activeColor) : null),
          inactiveColor: (tree.materialSlider.hasInactiveColor() ? types.evaluateDartColorExpression(tree.materialSlider.inactiveColor) : null),
          secondaryActiveColor: (tree.materialSlider.hasSecondaryActiveColor() ? types.evaluateDartColorExpression(tree.materialSlider.secondaryActiveColor) : null),
          thumbColor: (tree.materialSlider.hasThumbColor() ? types.evaluateDartColorExpression(tree.materialSlider.thumbColor) : null),
          overlayColor: null,
          mouseCursor: null,
    ...
    case proto.WidgetExpression_Result.materialSliderNamedAdaptive:
      return $c158.Slider.adaptive(
          ...
          mouseCursor: null,
          activeColor: (tree.materialSliderNamedAdaptive.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialSliderNamedAdaptive.activeColor) : null),
          inactiveColor: (tree.materialSliderNamedAdaptive.hasInactiveColor() ? types.evaluateDartColorExpression(tree.materialSliderNamedAdaptive.inactiveColor) : null),
          secondaryActiveColor: (tree.materialSliderNamedAdaptive.hasSecondaryActiveColor() ? types.evaluateDartColorExpression(tree.materialSliderNamedAdaptive.secondaryActiveColor) : null),
          thumbColor: (tree.materialSliderNamedAdaptive.hasThumbColor() ? types.evaluateDartColorExpression(tree.materialSliderNamedAdaptive.thumbColor) : null),
          overlayColor: null,
          semanticFormatterCallback: null,
          focusNode: null,
    ...
    case proto.WidgetExpression_Result.materialSnackBar:
      return $c159.SnackBar(
          ...
          closeIconColor: (tree.materialSnackBar.hasCloseIconColor() ? types.evaluateDartColorExpression(tree.materialSnackBar.closeIconColor) : null),
          duration: (tree.materialSnackBar.hasDuration() ? types.evaluateRequiredDartDurationExpression(tree.materialSnackBar.duration) : missing('duration')),
          animation: null,
          onVisible: null,
          dismissDirection: (tree.materialSnackBar.hasDismissDirection() ? enums.convertRequiredFlutterDismissDirection(tree.materialSnackBar.dismissDirection) : missing('dismissDirection')),
          clipBehavior: (tree.materialSnackBar.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialSnackBar.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.materialSwitch:
      return $c160.Switch(
          ...
          onChanged: null,
          activeColor: (tree.materialSwitch.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialSwitch.activeColor) : null),
          activeTrackColor: (tree.materialSwitch.hasActiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitch.activeTrackColor) : null),
          inactiveThumbColor: (tree.materialSwitch.hasInactiveThumbColor() ? types.evaluateDartColorExpression(tree.materialSwitch.inactiveThumbColor) : null),
          inactiveTrackColor: (tree.materialSwitch.hasInactiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitch.inactiveTrackColor) : null),
          ...
          dragStartBehavior: (tree.materialSwitch.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialSwitch.dragStartBehavior) : missing('dragStartBehavior')),
          mouseCursor: null,
          focusColor: (tree.materialSwitch.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialSwitch.focusColor) : null),
          hoverColor: (tree.materialSwitch.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialSwitch.hoverColor) : null),
          overlayColor: null,
    ...
    case proto.WidgetExpression_Result.materialSwitchNamedAdaptive:
      return $c161.Switch.adaptive(
          ...
          onChanged: null,
          activeColor: (tree.materialSwitchNamedAdaptive.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialSwitchNamedAdaptive.activeColor) : null),
          activeTrackColor: (tree.materialSwitchNamedAdaptive.hasActiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitchNamedAdaptive.activeTrackColor) : null),
          inactiveThumbColor: (tree.materialSwitchNamedAdaptive.hasInactiveThumbColor() ? types.evaluateDartColorExpression(tree.materialSwitchNamedAdaptive.inactiveThumbColor) : null),
          inactiveTrackColor: (tree.materialSwitchNamedAdaptive.hasInactiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitchNamedAdaptive.inactiveTrackColor) : null),
          activeThumbImage: null,
          onActiveThumbImageError: null,
          inactiveThumbImage: null,
          onInactiveThumbImageError: null,
          ...
          trackOutlineWidth: null,
          thumbIcon: null,
          dragStartBehavior: (tree.materialSwitchNamedAdaptive.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialSwitchNamedAdaptive.dragStartBehavior) : missing('dragStartBehavior')),
          mouseCursor: null,
          focusColor: (tree.materialSwitchNamedAdaptive.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialSwitchNamedAdaptive.focusColor) : null),
          hoverColor: (tree.materialSwitchNamedAdaptive.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialSwitchNamedAdaptive.hoverColor) : null),
          overlayColor: null,
    ...
    case proto.WidgetExpression_Result.materialSwitchListTile:
      return $c162.SwitchListTile(
          ...
          onChanged: null,
          activeColor: (tree.materialSwitchListTile.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTile.activeColor) : null),
          activeTrackColor: (tree.materialSwitchListTile.hasActiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTile.activeTrackColor) : null),
          inactiveThumbColor: (tree.materialSwitchListTile.hasInactiveThumbColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTile.inactiveThumbColor) : null),
          inactiveTrackColor: (tree.materialSwitchListTile.hasInactiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTile.inactiveTrackColor) : null),
          activeThumbImage: null,
          onActiveThumbImageError: null,
          inactiveThumbImage: null,
          onInactiveThumbImageError: null,
          ...
          dragStartBehavior: (tree.materialSwitchListTile.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialSwitchListTile.dragStartBehavior) : missing('dragStartBehavior')),
          mouseCursor: null,
          overlayColor: null,
          ...
          tileColor: (tree.materialSwitchListTile.hasTileColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTile.tileColor) : null),
          ...
          controlAffinity: (tree.materialSwitchListTile.hasControlAffinity() ? enums.convertRequiredMaterialListTileControlAffinity(tree.materialSwitchListTile.controlAffinity) : missing('controlAffinity')),
          shape: null,
          selectedTileColor: (tree.materialSwitchListTile.hasSelectedTileColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTile.selectedTileColor) : null),
          visualDensity: null,
    ...
    case proto.WidgetExpression_Result.materialSwitchListTileNamedAdaptive:
      return $c163.SwitchListTile.adaptive(
          ...
          onChanged: null,
          activeColor: (tree.materialSwitchListTileNamedAdaptive.hasActiveColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTileNamedAdaptive.activeColor) : null),
          activeTrackColor: (tree.materialSwitchListTileNamedAdaptive.hasActiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTileNamedAdaptive.activeTrackColor) : null),
          inactiveThumbColor: (tree.materialSwitchListTileNamedAdaptive.hasInactiveThumbColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTileNamedAdaptive.inactiveThumbColor) : null),
          inactiveTrackColor: (tree.materialSwitchListTileNamedAdaptive.hasInactiveTrackColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTileNamedAdaptive.inactiveTrackColor) : null),
          activeThumbImage: null,
          onActiveThumbImageError: null,
          inactiveThumbImage: null,
          onInactiveThumbImageError: null,
          ...
          dragStartBehavior: (tree.materialSwitchListTileNamedAdaptive.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialSwitchListTileNamedAdaptive.dragStartBehavior) : missing('dragStartBehavior')),
          mouseCursor: null,
          overlayColor: null,
          ...
          tileColor: (tree.materialSwitchListTileNamedAdaptive.hasTileColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTileNamedAdaptive.tileColor) : null),
          ...
          controlAffinity: (tree.materialSwitchListTileNamedAdaptive.hasControlAffinity() ? enums.convertRequiredMaterialListTileControlAffinity(tree.materialSwitchListTileNamedAdaptive.controlAffinity) : missing('controlAffinity')),
          shape: null,
          selectedTileColor: (tree.materialSwitchListTileNamedAdaptive.hasSelectedTileColor() ? types.evaluateDartColorExpression(tree.materialSwitchListTileNamedAdaptive.selectedTileColor) : null),
          visualDensity: null,
    ...
    case proto.WidgetExpression_Result.materialTabBar:
      return $c166.TabBar(
          ...
          padding: null,
          indicatorColor: (tree.materialTabBar.hasIndicatorColor() ? types.evaluateDartColorExpression(tree.materialTabBar.indicatorColor) : null),
          ...
          dragStartBehavior: (tree.materialTabBar.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialTabBar.dragStartBehavior) : missing('dragStartBehavior')),
          overlayColor: null,
          mouseCursor: null,
    ...
    case proto.WidgetExpression_Result.materialTabBarNamedSecondary:
      return $c167.TabBar.secondary(
          ...
          padding: null,
          indicatorColor: (tree.materialTabBarNamedSecondary.hasIndicatorColor() ? types.evaluateDartColorExpression(tree.materialTabBarNamedSecondary.indicatorColor) : null),
          ...
          unselectedLabelStyle: null,
          dragStartBehavior: (tree.materialTabBarNamedSecondary.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialTabBarNamedSecondary.dragStartBehavior) : missing('dragStartBehavior')),
          overlayColor: null,
          mouseCursor: null,
    ...
    case proto.WidgetExpression_Result.materialTabBarView:
      return $c168.TabBarView(
          ...
          controller: null,
          physics: null,
          dragStartBehavior: (tree.materialTabBarView.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialTabBarView.dragStartBehavior) : missing('dragStartBehavior')),
          viewportFraction: (tree.materialTabBarView.hasViewportFraction() ? tree.materialTabBarView.viewportFraction : 1.0),
          clipBehavior: (tree.materialTabBarView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialTabBarView.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.materialTabPageSelector:
      return $c169.TabPageSelector(
          ...
          color: (tree.materialTabPageSelector.hasColor() ? types.evaluateDartColorExpression(tree.materialTabPageSelector.color) : null),
    ...
    case proto.WidgetExpression_Result.materialTabPageSelectorIndicator:
      return $c170.TabPageSelectorIndicator(
          ...
          borderStyle: (tree.materialTabPageSelectorIndicator.hasBorderStyle() ? enums.convertRequiredFlutterBorderStyle(tree.materialTabPageSelectorIndicator.borderStyle) : missing('borderStyle')));
    ...
    case proto.WidgetExpression_Result.materialTextField:
      return $c173.TextField(
          ...
          textCapitalization: (tree.materialTextField.hasTextCapitalization() ? enums.convertRequiredFlutterTextCapitalization(tree.materialTextField.textCapitalization) : missing('textCapitalization')),
          style: null,
          strutStyle: null,
          textAlign: (tree.materialTextField.hasTextAlign() ? enums.convertRequiredDartTextAlign(tree.materialTextField.textAlign) : missing('textAlign')),
          textAlignVertical: null,
          ...
          cursorColor: (tree.materialTextField.hasCursorColor() ? types.evaluateDartColorExpression(tree.materialTextField.cursorColor) : null),
          ...
          dragStartBehavior: (tree.materialTextField.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialTextField.dragStartBehavior) : missing('dragStartBehavior')),
          ...
          contentInsertionConfiguration: null,
          clipBehavior: (tree.materialTextField.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialTextField.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.materialTextFormField:
      return $c174.TextFormField(
          ...
          decoration: null,
          keyboardType: null,
          textCapitalization: (tree.materialTextFormField.hasTextCapitalization() ? enums.convertRequiredFlutterTextCapitalization(tree.materialTextFormField.textCapitalization) : missing('textCapitalization')),
          ...
          textAlign: (tree.materialTextFormField.hasTextAlign() ? enums.convertRequiredDartTextAlign(tree.materialTextFormField.textAlign) : missing('textAlign')),
          textAlignVertical: null,
          ...
          cursorRadius: null,
          cursorColor: (tree.materialTextFormField.hasCursorColor() ? types.evaluateDartColorExpression(tree.materialTextFormField.cursorColor) : null),
          ...
          dragStartBehavior: (tree.materialTextFormField.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.materialTextFormField.dragStartBehavior) : missing('dragStartBehavior')),
          contentInsertionConfiguration: null,
          clipBehavior: (tree.materialTextFormField.hasClipBehavior() ? enums.convertRequiredDartClip(tree.materialTextFormField.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.materialToggleButtons:
      return $c175.ToggleButtons(
          ...
          disabledColor: (tree.materialToggleButtons.hasDisabledColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.disabledColor) : null),
          fillColor: (tree.materialToggleButtons.hasFillColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.fillColor) : null),
          focusColor: (tree.materialToggleButtons.hasFocusColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.focusColor) : null),
          highlightColor: (tree.materialToggleButtons.hasHighlightColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.highlightColor) : null),
          hoverColor: (tree.materialToggleButtons.hasHoverColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.hoverColor) : null),
          splashColor: (tree.materialToggleButtons.hasSplashColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.splashColor) : null),
          focusNodes: null,
          renderBorder: (tree.materialToggleButtons.hasRenderBorder() ? tree.materialToggleButtons.renderBorder : true),
          borderColor: (tree.materialToggleButtons.hasBorderColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.borderColor) : null),
          selectedBorderColor: (tree.materialToggleButtons.hasSelectedBorderColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.selectedBorderColor) : null),
          disabledBorderColor: (tree.materialToggleButtons.hasDisabledBorderColor() ? types.evaluateDartColorExpression(tree.materialToggleButtons.disabledBorderColor) : null),
          borderRadius: null,
          borderWidth: (tree.materialToggleButtons.hasBorderWidth() ? tree.materialToggleButtons.borderWidth : null),
          direction: (tree.materialToggleButtons.hasDirection() ? enums.convertRequiredFlutterAxis(tree.materialToggleButtons.direction) : missing('direction')),
          verticalDirection: (tree.materialToggleButtons.hasVerticalDirection() ? enums.convertRequiredFlutterVerticalDirection(tree.materialToggleButtons.verticalDirection) : missing('verticalDirection')));
    ...
    case proto.WidgetExpression_Result.flutterAnimatedSize:
      return $c182.AnimatedSize(
          ...
          clipBehavior: (tree.flutterAnimatedSize.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterAnimatedSize.clipBehavior) : missing('clipBehavior')));
    ...
    case proto.WidgetExpression_Result.flutterAutofillGroup:
      return $c186.AutofillGroup(
          ...
          onDisposeAction: (tree.flutterAutofillGroup.hasOnDisposeAction() ? enums.convertRequiredFlutterAutofillContextAction(tree.flutterAutofillGroup.onDisposeAction) : missing('onDisposeAction')));
    ...
    case proto.WidgetExpression_Result.flutterClipOval:
      return $c196.ClipOval(
          ...
          clipper: null,
          clipBehavior: (tree.flutterClipOval.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterClipOval.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterClipPath:
      return $c197.ClipPath(
          ...
          clipper: null,
          clipBehavior: (tree.flutterClipPath.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterClipPath.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterClipRRect:
      return $c198.ClipRRect(
          ...
          clipper: null,
          clipBehavior: (tree.flutterClipRRect.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterClipRRect.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterClipRect:
      return $c199.ClipRect(
          ...
          clipper: null,
          clipBehavior: (tree.flutterClipRect.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterClipRect.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterColumn:
      return $c201.Column(
          ...
          mainAxisAlignment: (tree.flutterColumn.hasMainAxisAlignment() ? enums.convertRequiredFlutterMainAxisAlignment(tree.flutterColumn.mainAxisAlignment) : missing('mainAxisAlignment')),
          mainAxisSize: (tree.flutterColumn.hasMainAxisSize() ? enums.convertRequiredFlutterMainAxisSize(tree.flutterColumn.mainAxisSize) : missing('mainAxisSize')),
          crossAxisAlignment: (tree.flutterColumn.hasCrossAxisAlignment() ? enums.convertRequiredFlutterCrossAxisAlignment(tree.flutterColumn.crossAxisAlignment) : missing('crossAxisAlignment')),
          textDirection: (tree.flutterColumn.hasTextDirection() ? enums.convertDartTextDirection(tree.flutterColumn.textDirection) : null),
          verticalDirection: (tree.flutterColumn.hasVerticalDirection() ? enums.convertRequiredFlutterVerticalDirection(tree.flutterColumn.verticalDirection) : missing('verticalDirection')),
    ...
    case proto.WidgetExpression_Result.flutterFittedBox:
      return $c206.FittedBox(
          ...
          fit: (tree.flutterFittedBox.hasFit() ? enums.convertRequiredFlutterBoxFit(tree.flutterFittedBox.fit) : missing('fit')),
          clipBehavior: (tree.flutterFittedBox.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterFittedBox.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterFlex:
      return $c207.Flex(
          ...
          mainAxisAlignment: (tree.flutterFlex.hasMainAxisAlignment() ? enums.convertRequiredFlutterMainAxisAlignment(tree.flutterFlex.mainAxisAlignment) : missing('mainAxisAlignment')),
          mainAxisSize: (tree.flutterFlex.hasMainAxisSize() ? enums.convertRequiredFlutterMainAxisSize(tree.flutterFlex.mainAxisSize) : missing('mainAxisSize')),
          crossAxisAlignment: (tree.flutterFlex.hasCrossAxisAlignment() ? enums.convertRequiredFlutterCrossAxisAlignment(tree.flutterFlex.crossAxisAlignment) : missing('crossAxisAlignment')),
          textDirection: (tree.flutterFlex.hasTextDirection() ? enums.convertDartTextDirection(tree.flutterFlex.textDirection) : null),
          verticalDirection: (tree.flutterFlex.hasVerticalDirection() ? enums.convertRequiredFlutterVerticalDirection(tree.flutterFlex.verticalDirection) : missing('verticalDirection')),
          textBaseline: (tree.flutterFlex.hasTextBaseline() ? enums.convertDartTextBaseline(tree.flutterFlex.textBaseline) : null),
          clipBehavior: (tree.flutterFlex.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterFlex.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterFlexible:
      return $c208.Flexible(
          ...
          fit: (tree.flutterFlexible.hasFit() ? enums.convertRequiredFlutterFlexFit(tree.flutterFlexible.fit) : missing('fit')),
    ...
    case proto.WidgetExpression_Result.flutterIndexedStack:
      return $c212.IndexedStack(
          ...
          clipBehavior: (tree.flutterIndexedStack.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterIndexedStack.clipBehavior) : missing('clipBehavior')),
          sizing: (tree.flutterIndexedStack.hasSizing() ? enums.convertRequiredFlutterStackFit(tree.flutterIndexedStack.sizing) : missing('sizing')),
    ...
    case proto.WidgetExpression_Result.flutterListBody:
      return $c218.ListBody(
          ...
          mainAxis: (tree.flutterListBody.hasMainAxis() ? enums.convertRequiredFlutterAxis(tree.flutterListBody.mainAxis) : missing('mainAxis')),
    ...
    case proto.WidgetExpression_Result.flutterListener:
      return $c219.Listener(
          ...
          behavior: (tree.flutterListener.hasBehavior() ? enums.convertRequiredFlutterHitTestBehavior(tree.flutterListener.behavior) : missing('behavior')),
    ...
    case proto.WidgetExpression_Result.flutterMetaData:
      return $c221.MetaData(
          ...
          behavior: (tree.flutterMetaData.hasBehavior() ? enums.convertRequiredFlutterHitTestBehavior(tree.flutterMetaData.behavior) : missing('behavior')),
    ...
    case proto.WidgetExpression_Result.flutterPhysicalModel:
      return $c226.PhysicalModel(
          ...
          shape: (tree.flutterPhysicalModel.hasShape() ? enums.convertRequiredFlutterBoxShape(tree.flutterPhysicalModel.shape) : missing('shape')),
          clipBehavior: (tree.flutterPhysicalModel.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterPhysicalModel.clipBehavior) : missing('clipBehavior')),
          borderRadius: null,
          elevation: (tree.flutterPhysicalModel.hasElevation() ? tree.flutterPhysicalModel.elevation : 0.0),
          color: (tree.flutterPhysicalModel.hasColor() ? types.evaluateRequiredDartColorExpression(tree.flutterPhysicalModel.color) : missing('color')),
    ...
    case proto.WidgetExpression_Result.flutterRawImage:
      return $c231.RawImage(
          ...
          color: (tree.flutterRawImage.hasColor() ? types.evaluateDartColorExpression(tree.flutterRawImage.color) : null),
          opacity: null,
          ...
          repeat: (tree.flutterRawImage.hasRepeat() ? enums.convertRequiredFlutterImageRepeat(tree.flutterRawImage.repeat) : missing('repeat')),
          centerSlice: null,
          ...
          filterQuality: (tree.flutterRawImage.hasFilterQuality() ? enums.convertRequiredDartFilterQuality(tree.flutterRawImage.filterQuality) : missing('filterQuality')),
    ...
    case proto.WidgetExpression_Result.flutterRow:
      return $c235.Row(
          ...
          mainAxisAlignment: (tree.flutterRow.hasMainAxisAlignment() ? enums.convertRequiredFlutterMainAxisAlignment(tree.flutterRow.mainAxisAlignment) : missing('mainAxisAlignment')),
          mainAxisSize: (tree.flutterRow.hasMainAxisSize() ? enums.convertRequiredFlutterMainAxisSize(tree.flutterRow.mainAxisSize) : missing('mainAxisSize')),
          crossAxisAlignment: (tree.flutterRow.hasCrossAxisAlignment() ? enums.convertRequiredFlutterCrossAxisAlignment(tree.flutterRow.crossAxisAlignment) : missing('crossAxisAlignment')),
          textDirection: (tree.flutterRow.hasTextDirection() ? enums.convertDartTextDirection(tree.flutterRow.textDirection) : null),
          verticalDirection: (tree.flutterRow.hasVerticalDirection() ? enums.convertRequiredFlutterVerticalDirection(tree.flutterRow.verticalDirection) : missing('verticalDirection')),
    ...
    case proto.WidgetExpression_Result.flutterStack:
      return $c243.Stack(
          ...
          fit: (tree.flutterStack.hasFit() ? enums.convertRequiredFlutterStackFit(tree.flutterStack.fit) : missing('fit')),
          clipBehavior: (tree.flutterStack.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterStack.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterUnconstrainedBox:
      return $c247.UnconstrainedBox(
          ...
          clipBehavior: (tree.flutterUnconstrainedBox.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterUnconstrainedBox.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.flutterWrap:
      return $c248.Wrap(
          ...
          direction: (tree.flutterWrap.hasDirection() ? enums.convertRequiredFlutterAxis(tree.flutterWrap.direction) : missing('direction')),
          alignment: (tree.flutterWrap.hasAlignment() ? enums.convertRequiredFlutterWrapAlignment(tree.flutterWrap.alignment) : missing('alignment')),
          spacing: (tree.flutterWrap.hasSpacing() ? tree.flutterWrap.spacing : 0.0),
          runAlignment: (tree.flutterWrap.hasRunAlignment() ? enums.convertRequiredFlutterWrapAlignment(tree.flutterWrap.runAlignment) : missing('runAlignment')),
          runSpacing: (tree.flutterWrap.hasRunSpacing() ? tree.flutterWrap.runSpacing : 0.0),
          crossAxisAlignment: (tree.flutterWrap.hasCrossAxisAlignment() ? enums.convertRequiredFlutterWrapCrossAlignment(tree.flutterWrap.crossAxisAlignment) : missing('crossAxisAlignment')),
          textDirection: (tree.flutterWrap.hasTextDirection() ? enums.convertDartTextDirection(tree.flutterWrap.textDirection) : null),
          verticalDirection: (tree.flutterWrap.hasVerticalDirection() ? enums.convertRequiredFlutterVerticalDirection(tree.flutterWrap.verticalDirection) : missing('verticalDirection')),
          clipBehavior: (tree.flutterWrap.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterWrap.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterContainer:
      return $c249.Container(
          ...
          alignment: null,
          padding: null,
          color: (tree.flutterContainer.hasColor() ? types.evaluateDartColorExpression(tree.flutterContainer.color) : null),
          decoration: null,
          ...
          clipBehavior: (tree.flutterContainer.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterContainer.clipBehavior) : missing('clipBehavior')));
    ...
    case proto.WidgetExpression_Result.flutterDismissible:
      return $c253.Dismissible(
          ...
          onUpdate: null,
          onDismissed: null,
          direction: (tree.flutterDismissible.hasDirection() ? enums.convertRequiredFlutterDismissDirection(tree.flutterDismissible.direction) : missing('direction')),
          resizeDuration: (tree.flutterDismissible.hasResizeDuration() ? types.evaluateDartDurationExpression(tree.flutterDismissible.resizeDuration) : null),
          movementDuration: (tree.flutterDismissible.hasMovementDuration() ? types.evaluateRequiredDartDurationExpression(tree.flutterDismissible.movementDuration) : missing('movementDuration')),
          crossAxisEndOffset: (tree.flutterDismissible.hasCrossAxisEndOffset() ? tree.flutterDismissible.crossAxisEndOffset : 0.0),
          dragStartBehavior: (tree.flutterDismissible.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterDismissible.dragStartBehavior) : missing('dragStartBehavior')),
          behavior: (tree.flutterDismissible.hasBehavior() ? enums.convertRequiredFlutterHitTestBehavior(tree.flutterDismissible.behavior) : missing('behavior')));
    ...
    case proto.WidgetExpression_Result.flutterDraggable:
      return $c255.Draggable(
          ...
          hitTestBehavior: (tree.flutterDraggable.hasHitTestBehavior() ? enums.convertRequiredFlutterHitTestBehavior(tree.flutterDraggable.hitTestBehavior) : missing('hitTestBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterFadeInImageNamedAssetNetwork:
      return $c258.FadeInImage.assetNetwork(
          ...
          fadeOutDuration: (tree.flutterFadeInImageNamedAssetNetwork.hasFadeOutDuration() ? types.evaluateRequiredDartDurationExpression(tree.flutterFadeInImageNamedAssetNetwork.fadeOutDuration) : missing('fadeOutDuration')),
          fadeInDuration: (tree.flutterFadeInImageNamedAssetNetwork.hasFadeInDuration() ? types.evaluateRequiredDartDurationExpression(tree.flutterFadeInImageNamedAssetNetwork.fadeInDuration) : missing('fadeInDuration')),
          ...
          filterQuality: (tree.flutterFadeInImageNamedAssetNetwork.hasFilterQuality() ? enums.convertRequiredDartFilterQuality(tree.flutterFadeInImageNamedAssetNetwork.filterQuality) : missing('filterQuality')),
          ...
          repeat: (tree.flutterFadeInImageNamedAssetNetwork.hasRepeat() ? enums.convertRequiredFlutterImageRepeat(tree.flutterFadeInImageNamedAssetNetwork.repeat) : missing('repeat')),
    ...
    case proto.WidgetExpression_Result.flutterGestureDetector:
      return $c266.GestureDetector(
          ...
          dragStartBehavior: (tree.flutterGestureDetector.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterGestureDetector.dragStartBehavior) : missing('dragStartBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterIcon:
      return $c270.Icon(
          ...
          color: (tree.flutterIcon.hasColor() ? types.evaluateDartColorExpression(tree.flutterIcon.color) : null),
          shadows: null,
    ...
    case proto.WidgetExpression_Result.flutterImageNamedNetwork:
      return $c271.Image.network(
          ...
          color: (tree.flutterImageNamedNetwork.hasColor() ? types.evaluateDartColorExpression(tree.flutterImageNamedNetwork.color) : null),
          opacity: null,
          ...
          repeat: (tree.flutterImageNamedNetwork.hasRepeat() ? enums.convertRequiredFlutterImageRepeat(tree.flutterImageNamedNetwork.repeat) : missing('repeat')),
          centerSlice: null,
          ...
          filterQuality: (tree.flutterImageNamedNetwork.hasFilterQuality() ? enums.convertRequiredDartFilterQuality(tree.flutterImageNamedNetwork.filterQuality) : missing('filterQuality')),
    ...
    case proto.WidgetExpression_Result.flutterImageNamedAsset:
      return $c272.Image.asset(
          ...
          color: (tree.flutterImageNamedAsset.hasColor() ? types.evaluateDartColorExpression(tree.flutterImageNamedAsset.color) : null),
          opacity: null,
          ...
          repeat: (tree.flutterImageNamedAsset.hasRepeat() ? enums.convertRequiredFlutterImageRepeat(tree.flutterImageNamedAsset.repeat) : missing('repeat')),
          centerSlice: null,
          ...
          filterQuality: (tree.flutterImageNamedAsset.hasFilterQuality() ? enums.convertRequiredDartFilterQuality(tree.flutterImageNamedAsset.filterQuality) : missing('filterQuality')),
    ...
    case proto.WidgetExpression_Result.flutterAnimatedContainer:
      return $c274.AnimatedContainer(
          ...
          alignment: null,
          padding: null,
          color: (tree.flutterAnimatedContainer.hasColor() ? types.evaluateDartColorExpression(tree.flutterAnimatedContainer.color) : null),
          decoration: null,
          foregroundDecoration: null,
          ...
          clipBehavior: (tree.flutterAnimatedContainer.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterAnimatedContainer.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterAnimatedOpacity:
      return $c276.AnimatedOpacity(
          ...
          duration: (tree.flutterAnimatedOpacity.hasDuration() ? types.evaluateRequiredDartDurationExpression(tree.flutterAnimatedOpacity.duration) : missing('duration')),
          onEnd: null,
    ...
    case proto.WidgetExpression_Result.flutterAnimatedPhysicalModel:
      return $c277.AnimatedPhysicalModel(
          ...
          clipBehavior: (tree.flutterAnimatedPhysicalModel.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterAnimatedPhysicalModel.clipBehavior) : missing('clipBehavior')),
          elevation: (tree.flutterAnimatedPhysicalModel.hasElevation() ? tree.flutterAnimatedPhysicalModel.elevation : missing('elevation')),
          color: (tree.flutterAnimatedPhysicalModel.hasColor() ? types.evaluateRequiredDartColorExpression(tree.flutterAnimatedPhysicalModel.color) : missing('color')),
          animateColor: (tree.flutterAnimatedPhysicalModel.hasAnimateColor() ? tree.flutterAnimatedPhysicalModel.animateColor : true),
          shadowColor: (tree.flutterAnimatedPhysicalModel.hasShadowColor() ? types.evaluateRequiredDartColorExpression(tree.flutterAnimatedPhysicalModel.shadowColor) : missing('shadowColor')),
    ...
    case proto.WidgetExpression_Result.flutterSliverAnimatedOpacity:
      return $c282.SliverAnimatedOpacity(
          ...
          duration: (tree.flutterSliverAnimatedOpacity.hasDuration() ? types.evaluateRequiredDartDurationExpression(tree.flutterSliverAnimatedOpacity.duration) : missing('duration')),
          onEnd: null,
    ...
    case proto.WidgetExpression_Result.flutterInteractiveViewer:
      return $c283.InteractiveViewer(
          ...
          clipBehavior: (tree.flutterInteractiveViewer.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterInteractiveViewer.clipBehavior) : missing('clipBehavior')),
          panAxis: (tree.flutterInteractiveViewer.hasPanAxis() ? enums.convertRequiredFlutterPanAxis(tree.flutterInteractiveViewer.panAxis) : missing('panAxis')),
    ...
    case proto.WidgetExpression_Result.flutterListWheelScrollView:
      return $c284.ListWheelScrollView(
          ...
          clipBehavior: (tree.flutterListWheelScrollView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterListWheelScrollView.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterNavigator:
      return $c289.Navigator(
          ...
          clipBehavior: (tree.flutterNavigator.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterNavigator.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterOverflowBar:
      return $c291.OverflowBar(
          ...
          overflowAlignment: (tree.flutterOverflowBar.hasOverflowAlignment() ? enums.convertRequiredFlutterOverflowBarAlignment(tree.flutterOverflowBar.overflowAlignment) : missing('overflowAlignment')),
          overflowDirection: (tree.flutterOverflowBar.hasOverflowDirection() ? enums.convertRequiredFlutterVerticalDirection(tree.flutterOverflowBar.overflowDirection) : missing('overflowDirection')),
          ...
          clipBehavior: (tree.flutterOverflowBar.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterOverflowBar.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterOverlay:
      return $c292.Overlay(
          ...
          clipBehavior: (tree.flutterOverlay.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterOverlay.clipBehavior) : missing('clipBehavior')));
    ...
    case proto.WidgetExpression_Result.flutterStretchingOverscrollIndicator:
      return $c294.StretchingOverscrollIndicator(
          ...
          clipBehavior: (tree.flutterStretchingOverscrollIndicator.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterStretchingOverscrollIndicator.clipBehavior) : missing('clipBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterPageView:
      return $c295.PageView(
          ...
          scrollDirection: (tree.flutterPageView.hasScrollDirection() ? enums.convertRequiredFlutterAxis(tree.flutterPageView.scrollDirection) : missing('scrollDirection')),
          ...
          dragStartBehavior: (tree.flutterPageView.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterPageView.dragStartBehavior) : missing('dragStartBehavior')),
          ...
          clipBehavior: (tree.flutterPageView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterPageView.clipBehavior) : missing('clipBehavior')),
          scrollBehavior: null,
    ...
    case proto.WidgetExpression_Result.flutterAndroidView:
      return $c299.AndroidView(
          ...
          hitTestBehavior: (tree.flutterAndroidView.hasHitTestBehavior() ? enums.convertRequiredFlutterPlatformViewHitTestBehavior(tree.flutterAndroidView.hitTestBehavior) : missing('hitTestBehavior')),
          ...
          clipBehavior: (tree.flutterAndroidView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterAndroidView.clipBehavior) : missing('clipBehavior')));
    ...
    case proto.WidgetExpression_Result.flutterUiKitView:
      return $c301.UiKitView(
          ...
          onPlatformViewCreated: null,
          hitTestBehavior: (tree.flutterUiKitView.hasHitTestBehavior() ? enums.convertRequiredFlutterPlatformViewHitTestBehavior(tree.flutterUiKitView.hitTestBehavior) : missing('hitTestBehavior')),
    ...
    case proto.WidgetExpression_Result.flutterCustomScrollView:
      return $c311.CustomScrollView(
          ...
          scrollDirection: (tree.flutterCustomScrollView.hasScrollDirection() ? enums.convertRequiredFlutterAxis(tree.flutterCustomScrollView.scrollDirection) : missing('scrollDirection')),
          ...
          center: (tree.flutterCustomScrollView.hasCenter() ? types.evaluateFlutterKeyExpression(tree.flutterCustomScrollView.center) : null),
          ...
          dragStartBehavior: (tree.flutterCustomScrollView.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterCustomScrollView.dragStartBehavior) : missing('dragStartBehavior')),
          keyboardDismissBehavior: (tree.flutterCustomScrollView.hasKeyboardDismissBehavior() ? enums.convertRequiredFlutterScrollViewKeyboardDismissBehavior(tree.flutterCustomScrollView.keyboardDismissBehavior) : missing('keyboardDismissBehavior')),
          restorationId: (tree.flutterCustomScrollView.hasRestorationId() ? tree.flutterCustomScrollView.restorationId : null),
          clipBehavior: (tree.flutterCustomScrollView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterCustomScrollView.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.flutterGridViewNamedCount:
      return $c312.GridView.count(
          ...
          scrollDirection: (tree.flutterGridViewNamedCount.hasScrollDirection() ? enums.convertRequiredFlutterAxis(tree.flutterGridViewNamedCount.scrollDirection) : missing('scrollDirection')),
          ...
          dragStartBehavior: (tree.flutterGridViewNamedCount.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterGridViewNamedCount.dragStartBehavior) : missing('dragStartBehavior')),
          keyboardDismissBehavior: (tree.flutterGridViewNamedCount.hasKeyboardDismissBehavior() ? enums.convertRequiredFlutterScrollViewKeyboardDismissBehavior(tree.flutterGridViewNamedCount.keyboardDismissBehavior) : missing('keyboardDismissBehavior')),
          restorationId: (tree.flutterGridViewNamedCount.hasRestorationId() ? tree.flutterGridViewNamedCount.restorationId : null),
          clipBehavior: (tree.flutterGridViewNamedCount.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterGridViewNamedCount.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.flutterGridViewNamedExtent:
      return $c313.GridView.extent(
          ...
          scrollDirection: (tree.flutterGridViewNamedExtent.hasScrollDirection() ? enums.convertRequiredFlutterAxis(tree.flutterGridViewNamedExtent.scrollDirection) : missing('scrollDirection')),
          ...
          dragStartBehavior: (tree.flutterGridViewNamedExtent.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterGridViewNamedExtent.dragStartBehavior) : missing('dragStartBehavior')),
          keyboardDismissBehavior: (tree.flutterGridViewNamedExtent.hasKeyboardDismissBehavior() ? enums.convertRequiredFlutterScrollViewKeyboardDismissBehavior(tree.flutterGridViewNamedExtent.keyboardDismissBehavior) : missing('keyboardDismissBehavior')),
          restorationId: (tree.flutterGridViewNamedExtent.hasRestorationId() ? tree.flutterGridViewNamedExtent.restorationId : null),
          clipBehavior: (tree.flutterGridViewNamedExtent.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterGridViewNamedExtent.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.flutterListView:
      return $c314.ListView(
          ...
          scrollDirection: (tree.flutterListView.hasScrollDirection() ? enums.convertRequiredFlutterAxis(tree.flutterListView.scrollDirection) : missing('scrollDirection')),
          ...
          dragStartBehavior: (tree.flutterListView.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterListView.dragStartBehavior) : missing('dragStartBehavior')),
          keyboardDismissBehavior: (tree.flutterListView.hasKeyboardDismissBehavior() ? enums.convertRequiredFlutterScrollViewKeyboardDismissBehavior(tree.flutterListView.keyboardDismissBehavior) : missing('keyboardDismissBehavior')),
          restorationId: (tree.flutterListView.hasRestorationId() ? tree.flutterListView.restorationId : null),
          clipBehavior: (tree.flutterListView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterListView.clipBehavior) : missing('clipBehavior')));
    case proto.WidgetExpression_Result.flutterRawScrollbar:
      return $c315.RawScrollbar(
          ...
          trackRadius: null,
          trackColor: (tree.flutterRawScrollbar.hasTrackColor() ? types.evaluateDartColorExpression(tree.flutterRawScrollbar.trackColor) : null),
    ...
    case proto.WidgetExpression_Result.flutterSingleChildScrollView:
      return $c320.SingleChildScrollView(
          ...
          scrollDirection: (tree.flutterSingleChildScrollView.hasScrollDirection() ? enums.convertRequiredFlutterAxis(tree.flutterSingleChildScrollView.scrollDirection) : missing('scrollDirection')),
          ...
          dragStartBehavior: (tree.flutterSingleChildScrollView.hasDragStartBehavior() ? enums.convertRequiredFlutterDragStartBehavior(tree.flutterSingleChildScrollView.dragStartBehavior) : missing('dragStartBehavior')),
          clipBehavior: (tree.flutterSingleChildScrollView.hasClipBehavior() ? enums.convertRequiredDartClip(tree.flutterSingleChildScrollView.clipBehavior) : missing('clipBehavior')),
          restorationId: (tree.flutterSingleChildScrollView.hasRestorationId() ? tree.flutterSingleChildScrollView.restorationId : null),
          keyboardDismissBehavior: (tree.flutterSingleChildScrollView.hasKeyboardDismissBehavior() ? enums.convertRequiredFlutterScrollViewKeyboardDismissBehavior(tree.flutterSingleChildScrollView.keyboardDismissBehavior) : missing('keyboardDismissBehavior')));
    ...
    case proto.WidgetExpression_Result.flutterTable:
      return $c337.Table(
          ...
          border: null,
          defaultVerticalAlignment: (tree.flutterTable.hasDefaultVerticalAlignment() ? enums.convertRequiredFlutterTableCellVerticalAlignment(tree.flutterTable.defaultVerticalAlignment) : missing('defaultVerticalAlignment')),
    ...
    case proto.WidgetExpression_Result.flutterTapRegion:
      return $c339.TapRegion(
          ...
          behavior: (tree.flutterTapRegion.hasBehavior() ? enums.convertRequiredFlutterHitTestBehavior(tree.flutterTapRegion.behavior) : missing('behavior')),
          onTapOutside: null,
          onTapInside: null,
          groupId: null,
    ...
    case proto.WidgetExpression_Result.flutterTexture:
      return $c345.Texture(
          ...
          filterQuality: (tree.flutterTexture.hasFilterQuality() ? enums.convertRequiredDartFilterQuality(tree.flutterTexture.filterQuality) : missing('filterQuality')));
